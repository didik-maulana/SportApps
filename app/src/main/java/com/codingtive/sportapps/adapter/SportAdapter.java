...
public class SportAdapter extends RecyclerView.Adapter<SportAdapter.SportViewHolder> {
    ...
    private ItemSportListener listener;
    private List<Sport> sports = new ArrayList<>();

    public SportAdapter(ItemSportListener listener) {
    ...
    class SportViewHolder extends RecyclerView.ViewHolder {
        ...
        void bindItem(Sport sport) {
            ...
            cardView.setOnClickListener(getItemClickListener(sport));
        }

        private View.OnClickListener getItemClickListener(final Sport sport) {
            return new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    listener.onItemClicked(sport);
                }
            };
        }
    }
